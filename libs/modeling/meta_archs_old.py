...
class TriDet(nn.Module):
    ...
    def __init__(
        ...
        self.reg_range =  [ [ 0, 16 ], [ 16, 64 ], [ 64, 400 ] ]
        ...
        self.train_dropout = 0.05
        self.train_droppath = train_cfg['droppath']
        self.train_label_smoothing = train_cfg['label_smoothing']

        # test time config
        self.test_pre_nms_thresh = 0.002
        self.test_pre_nms_topk = 1000
        self.test_iou_threshold = 0
        self.test_min_score = 0.001
        self.test_max_seg_num = 250
        self.test_nms_method = test_cfg['nms_method']
        assert self.test_nms_method in ['soft', 'hard', 'none']
        #self.test_duration_thresh = test_cfg['duration_thresh']
        self.test_duration_thresh = 5
        self.test_multiclass_nms = True
        self.test_nms_sigma = test_cfg['nms_sigma']
        self.test_voting_thresh = 0.5
        ...
        self.loss_normalizer = 300
        self.loss_normalizer_momentum = 0.1
    ...
    def preprocessing(self, video_list, padding_val=0.0):
        ...
        if self.training:
            ...
            if self.input_noise > 0:
                print("self.input_noise: ",self.input_noise)
