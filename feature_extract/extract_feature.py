...
def test(cfg):
    ...
    #changes here
    checkpoint = torch.load("trained_slowfast_model.pyth")
    ...
    for vid_no, vid in enumerate(videos):
        ...
        vid_path = os.path.join(path_to_vid,vid_id+".avi")
        dataset = VideoSet(
           vid_path,cfg
        )
...
if __name__ == "__main__":
    ...
    #--cfg ./configs/SLOWFAST_8x8_R50.yaml
    #revise configs/SLOWFAST_8x8_R50.yaml path
